            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                            <h3>Images</h3>
                            <form action="{{route("admin.$view_used_for.aggrement_images.manage_process", $data->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="d-flex">
                                    ...
                                    <a href="{{route('admin.bdm.lead.view')}}/{{$bdm_lead->lead_id }}" type="submit" class="btn btn-sm btn-secondary text-light mx-3">Close</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script>
    ...
    let url = `{{route('admin.bdm.agreement_images.delete')}}/${data_id}`;
    if (userConfirmed) {
