                        ...
                        <div class="card-header border-0 text-light" style="background-color: var(--wb-renosand);">
                            ...
                            <div class="card-tools">
                                <select id="month-selector" class="form-control form-control-sm"
                                    ...
                                    <option value="{{ now()->subMonthsNoOverflow($i)->format('F Y') }}" {{ $i===0
                                        ? 'selected' : '' }} style="font-weight: 600;">
                        ...
                        <table class="table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center" style="font-weight: bold;">
                                    ...
                                    <td>
                                        <input type="number" style="width: 50px;" data-vm_id="{{ $vm->id }}"
                                            value="{{ $vm->wb_recce_target }}" onchange="wb_recce_target(this)">
                                    </td>
                                    <td class="recce_done_this_month_td">{{ $vm->recce_done_this_month }}</td>
                                    @php
                                    $val = $vm->wb_recce_percentage;
                                    if ($val < 50) { $bg_color='red' ; } elseif ($val==50) { $bg_color='darkgoldenrod' ;
                                        } elseif ($val> 50 && $val < 100) { $bg_color='green' ; } elseif ($val>= 100) {
                                            $bg_color = 'darkgreen';
                                            } else {
                                            $bg_color = null;
                                            }
