        ...
        <div class="container-fluid">
            ...
            @if (!isset($filter_params['dashboard_filters']))
                <div class="filter-container text-center d-none">
                    <form action="{{route('vendormanager.lead.list')}}" method="post">
                        @csrf
                        ...
                        <a href="{{route('vendormanager.lead.list')}}" class="btn btn-secondary btn-sm">Reset</a>
                    </form>
                </div>
            @endif
        </div>
        ...
        <div class="p-3 control-sidebar-content">
            ...
            <form action="{{route('vendormanager.lead.list')}}" method="post">
                ...
                <div class="my-5">
                    ...
                    <a href="{{route('vendormanager.lead.list')}}" type="submit" class="btn btn-sm btn-secondary btn-block">Reset</a>
                </div>
            </form>
        </div>
    </aside>
...
<script>
    const data_url = `{{route('vendormanager.lead.list.ajax')}}?{!!$filter!!}`;
