...
<div class="content-wrapper pb-5">
        ...
        <div class="container-fluid">
            ...
            <div class="filter-container text-center d-none">
                <form action="{{route('manager.bookings.list')}}" method="post">
                    ...
                    <a href="{{route('manager.bookings.list')}}" class="btn btn-secondary btn-sm">Reset</a>
                </form>
            </div>
            @endif
        </div>
    ...
    <aside class="control-sidebar control-sidebar-dark" style="display: none;">
        {{-- filter sidebar for booking page --}}
        <div class="p-3 control-sidebar-content">
            ...
            <form action="{{route('manager.bookings.list')}}" method="post">
                ...
                <div class="my-5">
                    ...
                    <a href="{{route('manager.bookings.list')}}" type="submit" class="btn btn-sm btn-secondary btn-block">Reset</a>
                </div>
            </form>
        </div>
    </aside>
...
<script>
    const data_url = `{{route('manager.bookings.list.ajax')}}?{!!$filter!!}`;
    ...
    function handle_view_lead(lead_id) {
        window.open(`{{route('manager.lead.view')}}/${lead_id}#bookings_card_container`);
    }
</script>
@endsection
