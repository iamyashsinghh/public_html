...
<div class="content-wrapper pb-5">
    ...
    <aside class="control-sidebar control-sidebar-dark" style="display: none;">
        <div class="p-3 control-sidebar-content">
            <h5>Visit Filters</h5>
            <hr class="mb-2">
            <form action="{{ route('manager.visit.list') }}" method="post" id="filters-form">
                @csrf
                <div class="accordion text-sm" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="btn btn-block btn-sm btn-secondary text-left text-bold text-light"
                                ...
                                aria-expanded="true" aria-controls="collapse41">Vm Name</button>
                        </h2>
                        <div id="collapse41"
                            ...
                            <div class="accordion-body pl-2 pb-4">
                                ...
                                <div class="custom-control custom-checkbox my-1">
                                    <input class="custom-control-input" type="checkbox" id="team_member_{{ $vm->id }}"
                                        name="team_members[]" value="{{ $vm->id }}" {{
                                        isset($filter_params['team_members']) && in_array($vm->id,
                                    $filter_params['team_members']) ? 'checked' : '' }}>
                                    <label for="team_member_{{ $vm->id }}" class="custom-control-label">{{
                                        $vm->name }}</label>
                                </div>
                                @endforeach
                            </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="btn btn-block btn-sm btn-secondary text-left text-bold text-light"
                                type="button" data-bs-toggle="collapse" data-bs-target="#collapse413"
                                aria-expanded="true" aria-controls="collapse413">Venue</button>
                        </h2>
                        <div id="collapse413"
                            class="accordion-collapse collapse {{ isset($filter_params['venue']) ? 'show' : '' }}"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body pl-2 pb-4">
                                @foreach ($venues as $venue)
                                <div class="custom-control custom-checkbox my-1">
                                    <input class="custom-control-input" type="checkbox" id="venue_{{ $venue->name }}"
                                        name="venue[]" value="{{ $venue->name }}" {{
                                        isset($filter_params['venue']) && in_array($venue->name,
                                    $filter_params['venue']) ? 'checked' : '' }}>
                                    <label for="venue_{{ $venue->name }}" class="custom-control-label">{{
                                        $venue->name }}</label>
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div id="collapse11"
                            ...
                            <div class="accordion-body pl-2 pb-4">
                                <div class="custom-control custom-radio my-1">
                                    <input id="checkbox1" class="custom-control-input" type="radio" name="visits_source"
                                        value="WB|Team" {{ isset($filter_params['visits_source']) &&
                                        $filter_params['visits_source']=='WB|Team' ? 'checked' : '' }}>
                                    <label for="checkbox1" class="custom-control-label">WB|Team</label>
                                </div>
                                <div class="custom-control custom-radio my-1">
                                    <input id="checkbox5" class="custom-control-input" type="radio" name="visits_source"
                                        value="VM|Reference" {{ isset($filter_params['visits_source']) &&
                                        $filter_params['visits_source']=='VM|Reference' ? 'checked' : '' }}>
                                    <label for="checkbox5" class="custom-control-label">VM|Reference</label>
                                </div>
                                <div class="custom-control custom-radio my-1">
                                    <input id="checkbox2" class="custom-control-input" type="radio" name="visits_source"
                                        value="WB|Call" {{ isset($filter_params['visits_source']) &&
                                        $filter_params['visits_source']=='WB|Call' ? 'checked' : '' }}>
                                    <label for="checkbox2" class="custom-control-label">WB|Call</label>
                                </div>
                                <div class="custom-control custom-radio my-1">
                                    <input id="checkbox3" class="custom-control-input" type="radio" name="visits_source"
                                        value="Walk-in" {{ isset($filter_params['visits_source']) &&
                                        $filter_params['visits_source']=='Walk-in' ? 'checked' : '' }}>
                                    <label for="checkbox3" class="custom-control-label">Walk-in</label>
                                </div>
                                <div class="custom-control custom-radio my-1">
                                    <input id="checkbox4" class="custom-control-input" type="radio" name="visits_source"
                                        value="Other" {{ isset($filter_params['visits_source']) &&
                                        $filter_params['visits_source']=='Other' ? 'checked' : '' }}>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="btn btn-block btn-sm btn-secondary text-left text-bold text-light"
                                ...
                                aria-controls="collapse1">Visit Status</button>
                        </h2>
                        <div id="collapse1"
                            ...
                            <div class="accordion-body pl-2 pb-4">
                                <div class="custom-control custom-radio my-1">
                                    <input class="custom-control-input" type="radio" id="visit_status_upcoming_radio"
                                        name="visit_status" value="Upcoming" {{ isset($filter_params['visit_status']) &&
                                        $filter_params['visit_status']=='Upcoming' ? 'checked' : '' }}>
                                    <label for="visit_status_upcoming_radio"
                                        class="custom-control-label">Upcoming</label>
                                </div>
                                <div class="custom-control custom-radio my-1">
                                    <input class="custom-control-input" type="radio" id="visit_status_today_radio"
                                        name="visit_status" value="Today" {{ isset($filter_params['visit_status']) &&
                                        $filter_params['visit_status']=='Today' ? 'checked' : '' }}>
                                    <label for="visit_status_today_radio" class="custom-control-label">Today</label>
                                </div>
                                <div class="custom-control custom-radio my-1">
                                    <input class="custom-control-input" type="radio" id="visit_status_overdue_radio"
                                        name="visit_status" value="Overdue" {{ isset($filter_params['visit_status']) &&
                                        $filter_params['visit_status']=='Overdue' ? 'checked' : '' }}>
                                    <label for="visit_status_overdue_radio" class="custom-control-label">Overdue</label>
                                </div>
                                <div class="custom-control custom-radio my-1">
                                    <input class="custom-control-input" type="radio" id="visit_status_done_radio"
                                        name="visit_status" value="Done" {{ isset($filter_params['visit_status']) &&
                                        $filter_params['visit_status']=='Done' ? 'checked' : '' }}>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="btn btn-block btn-sm btn-secondary text-left text-bold text-light"
                                ...
                                aria-controls="collapse2">Visit Created Date</button>
                        </h2>
                        <div id="collapse2"
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="btn btn-block btn-sm btn-secondary text-left text-bold text-light"
                                ...
                                aria-controls="collapse3">visit Done Date</button>
                        </h2>
                        <div id="collapse3"
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="btn btn-block btn-sm btn-secondary text-left text-bold text-light"
                                ...
                                aria-controls="collapse3">Visit Schedule Date</button>
                        </h2>
                        <div id="collapse4"
                ...
                <div class="my-5">
                    ...
                    <a href="{{ route('manager.visit.list') }}" type="submit"
        ...
        $(document).ready(function() {
            var dataTable = $('#serverTable').DataTable({
                ...
                rowCallback: function(row, data, index) {
                    ...
                    td_elements[12].innerText = moment(data.visit_created_datetime).format(
                        "DD-MMM-YYYY hh:mm a");
                    td_elements[13].innerText = data.visit_done_datetime ? moment(data
