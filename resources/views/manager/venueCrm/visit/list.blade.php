                                ...
                                <div class="accordion-body pl-2 pb-4">
                                    <div class="custom-control custom-radio my-1">
                                        <input class="custom-control-input" type="radio"
                                            id="visit_status_upcoming_radio" name="visit_status" value="Upcoming"
                                            {{ isset($filter_params['visit_status']) && $filter_params['visit_status'] == 'Upcoming' ? 'checked' : '' }}>
                                    ...
                                    <div class="custom-control custom-radio my-1">
                                        <input class="custom-control-input" type="radio" id="visit_status_today_radio"
                                            ...
                                            {{ isset($filter_params['visit_status']) && $filter_params['visit_status'] == 'Today' ? 'checked' : '' }}>
                                        <label for="visit_status_today_radio" class="custom-control-label">Today</label>
                                    </div>
                                    <div class="custom-control custom-radio my-1">
                                        <input class="custom-control-input" type="radio"
                                            id="visit_status_overdue_radio" name="visit_status" value="Overdue"
                                            {{ isset($filter_params['visit_status']) && $filter_params['visit_status'] == 'Overdue' ? 'checked' : '' }}>
                                        <label for="visit_status_overdue_radio"
                                    ...
                                    <div class="custom-control custom-radio my-1">
                                        <input class="custom-control-input" type="radio" id="visit_status_done_radio"
                                            ...
                                            {{ isset($filter_params['visit_status']) && $filter_params['visit_status'] == 'Done' ? 'checked' : '' }}>
