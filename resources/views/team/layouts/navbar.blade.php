...
<nav class="main-header navbar navbar-expand navbar-dark navbar-light" style="background: var(--wb-renosand)">
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="javascript:void(0);" class="nav-link" data-bs-toggle="modal" data-bs-target="#manageLeadModal">Create Lead</a>
        </li>
        @endif
    </ul>
...
<x-create-venue-lead url-for-submit="{{route('team.lead.add.process')}}" />
