            ...
            <div class="p-3 control-sidebar-content">
                ...
                <form action="{{ route('team.visit.list') }}" method="post">
                    ...
                    <div class="my-5">
                        ...
                        <a href="{{ route('team.visit.list') }}" type="submit"
        ...
        $(document).ready(function() {
            $('#serverTable').DataTable({
                ...
                rowCallback: function(row, data, index) {
                    ...
                    td_elements[5].innerHTML = moment(data.visit_schedule_datetime).format(
                        "DD-MMM-YYYY hh:mm a");;
                    ...
                    td_elements[8].innerText = moment(data.visit_created_datetime).format(
                        "DD-MMM-YYYY hh:mm a");
                    td_elements[9].innerText = data.visit_done_datetime ? moment(data
