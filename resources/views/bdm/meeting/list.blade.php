...
<div class="content-wrapper pb-5">
    ...
    <aside class="control-sidebar control-sidebar-dark" style="display: none;">
        <div class="p-3 control-sidebar-content">
            ...
            <hr class="mb-2">
            <form action="{{route('bdm.meeting.list')}}" method="post" id="filters-form">
                @csrf
                ...
                <div class="my-5">
                    ...
                    <a href="{{route('bdm.meeting.list')}}" type="submit" class="btn btn-sm btn-secondary btn-block">Reset</a>
                </div>
            </form>
        </div>
    </aside>
...
<script>
    const data_url = `{{route('bdm.meeting.list.ajax')}}?{!!$filter!!}`;
