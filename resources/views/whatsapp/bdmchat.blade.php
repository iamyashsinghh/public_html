            ...
            <form action="" method="post" id="wa_msg_form">
                ...
                <div class="modal-footer text-sm">
                    <div class="mx-5 d-flex align-items-center">
                        ...
                        <a href="javascript:void(0);" class="mt-2 mx-2" style="margin-top: 0; color: #000; font-size: 1.5rem" id="uploadDocumentBtn"><i class="fa-sharp fa-solid fa-paperclip"></i></a>
                    </div>
            ...
            <div class="modal-body">
                <form id="documentUploadForm" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="documentTitle" name="documentTitle" required>
                    </div>
                    <div class="mb-3">
...
<script>
    ...
    $btn.prop('disabled', true);
        ...
        $.ajax({
            url: '{{ route('whatsapp_chat.send.bdm_greet_btn') }}',
            type: 'POST',
            data: data,
            dataType: 'json',
            success: function(response) {
