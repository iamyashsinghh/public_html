            ...
            <form action="" method="post" id="wa_msg_multiple_form">
                ...
                <div class="modal-body text-sm">
                    <div class="form-groupp">
                        ...
                        <option value="{{ $whatsapp_campaign->id }}">{{ $whatsapp_campaign->name }}--{{$whatsapp_campaign->team_name}}--{{ $whatsapp_campaign->is_rm_name == 1 ? 'Bdm Name In Template' : 'Lead Name In Template' }}</option>
                        @endforeach
                        </select>
                    </div>
                        <textarea class="form-control" id="phone_inp_id_m" name="phone_number_id_m"
